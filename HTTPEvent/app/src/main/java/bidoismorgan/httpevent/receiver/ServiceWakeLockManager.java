...
{
    /**
     * Private instance of WakeLock that is lazily initialized the first time {@link #aquireLock(android.content.Context)} is
     * called.
     */
    ...
    /**
     * Release a WakeLock. This method can only be called after a call to {@link #aquireLock(android.content.Context)}.
     */
