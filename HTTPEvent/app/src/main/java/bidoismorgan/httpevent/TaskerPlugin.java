...
public class TaskerPlugin {
	...
	/**
	 *	@see #addVariableBundle(android.os.Bundle, android.os.Bundle)
	 *	@see Host#getVariablesBundle(android.os.Bundle)
	 */
	...
	/**
     *  @see Setting#hostSupportsVariableReturn(android.os.Bundle)
     */
	public final static int			EXTRA_HOST_CAPABILITY_SETTING_RETURN_VARIABLES = 2;

	/**
     *	@see Condition#hostSupportsVariableReturn(android.os.Bundle)
     */
	public final static int			EXTRA_HOST_CAPABILITY_CONDITION_RETURN_VARIABLES = 4;

	/**
     * 	@see Setting#hostSupportsOnFireVariableReplacement(android.os.Bundle)
     */
	...
	/**
	 *
     *	@see #hostSupportsRelevantVariables(android.os.Bundle)
     *  @see #addRelevantVariableList(android.content.Intent, String[])
     *  @see #getRelevantVariableList(android.os.Bundle)
     */
	...
	*/
	...
	public static class Setting {
		...
		/**
		 *	@see #setVariableReplaceKeys(android.os.Bundle, String[])
	     */
        ...
        public final static int 		REQUESTED_TIMEOUT_MS_NEVER = REQUESTED_TIMEOUT_MS_MAX + 1000;
		 ...
		 /**
         *  @see #signalFinish(android.content.Context, android.content.Intent, int, android.os.Bundle)
         *  @see Host#addCompletionIntent(android.content.Intent, android.content.Intent)
         */
        private final static String EXTRA_PLUGIN_COMPLETION_INTENT = EXTRAS_PREFIX + "COMPLETION_INTENT";

		/**
         *  @see #signalFinish(android.content.Context, android.content.Intent, int, android.os.Bundle)
         *  @see Host#getSettingResultCode(android.content.Intent)
         */
		...
		*/
		 ...
		 * @see #hostSupportsOnFireVariableReplacement(android.os.Bundle)
		*/
		...
		*/
         ...
         * @see #hostSupportsSynchronousExecution(android.os.Bundle)
        */
	...
	public static class Event {
		...
		/**
		 * @param  extrasFromHost intent extras from the intent received by the QueryReceiver
		 * @see #addPassThroughData(android.content.Intent, android.os.Bundle)
		*/
		 ...
		 * @see #hostSupportsRequestQueryDataPassThrough(android.os.Bundle)
		 * @see #retrievePassThroughData(android.content.Intent)
	...
	public static class Host {
		...
		* Implementation is host-dependent.
		 ...
		 * @see #addCapabilities(android.content.Intent, int)
		*/
